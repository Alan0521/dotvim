...
def set_include_list(inclist):
    ...
    for b in vim.buffers:
        ...
        if not (b.name.endswith('.c') or b.name.endswith('.h') or
                b.name.endswith('.cpp') or b.name.endswith('.cxx') or
                b.name.endswith('.cc') or b.name.endswith('.hpp') or
                b.name.endswith('.hxx') or b.name.endswith('.hh')):
            continue
